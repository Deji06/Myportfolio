...
import DesktopView from '../assets/chatappSS.png'
  ...
  return (
    <>
       <div className='pb-10 mt-10 md:mt-0 bg-white animate-slide-in'style={{ animationDelay: "1s" }}>
        ...
        <div className='px-5 md:px-2 md:w-[70%] m-auto mt-10 space-y-5'>
            ...
            <div className='flex  md:flex-row flex-col gap-x-3 gap-y-5 pt-10'>
              <img 
                src={DesktopView} alt="mobile view for the chat app"  
                className='md:w-[80%] h-[400px] object-cover rounded-[10px]'
                loading='lazy'
              />
              <img 
                src={mobileView} 
