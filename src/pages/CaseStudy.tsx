    ...
    <div className='mt-16 space-y-5'>
      ...
      <div className='grid md:grid-cols-2 gap-y-3 gap-x-3 justify-between w-full p-2 mb-10'>
        <Link to={'/jobTracker'} className='w-fit space-y-3 p-3 h-full'>
          <img src={jobTracker} alt="job tracker app desktop view" 
            className=' object-contain w-fit h-auto rounded'
          />
          <div className='flex flex-col justify-between space-y-3'>
            <div className='flex justify-between'>
              <p className='capitalize'>job tracker app</p>
              <p className='text-[15px] capitalize'>sep <span className='text-[14px]'>25, 2025</span></p>
            </div>
            <div className='border-gradient w-full'></div>
            <div className='flex justify-between'>
              <p className='sm:text-[30px]'>job tracker app built with Next js and express js</p>
